$(document).ready(function(){
  ...
  var FEATURED_SONGS_METHOD ={
    handlerFeaturedSongsData: function(data){
      // Manipulations with JSON
      var oldData = data.track;
      var newData = [];
      var dataset = {};
      ...
      var nodes = d3.hierarchy(dataset)
              .sum(function(d) { return d.playcount; });
    ...
    loadFeaturedSongsData: function(){
      ...
      $.ajax({
        ...
        success: function(data){
          FEATURED_SONGS_METHOD.handlerFeaturedSongsData(data.tracks);
        }
      })
    }
  };
